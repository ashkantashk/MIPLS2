...
class PLS(PLSBase):
    ...
    def _get_initial_matrices(self, A: int, K: int, M: int, N: int) -> Tuple[jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray]:
    ...
    def _main_loop_body(self, i: int, X: jnp.ndarray, XTY: jnp.ndarray, M: int, K: int, P: jnp.ndarray, R: jnp.ndarray) -> Tuple[jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray]:
    ...
    def fit(self, X: jnp.ndarray, Y: jnp.ndarray, A: int) -> None:
        self.B, self.W, self.P, self.Q, self.R, self.T = self._fit_helper(
            X, Y, A)

    @partial(jax.jit, static_argnums=(0, 3))
    def _fit_helper(self, X: jnp.ndarray, Y: jnp.ndarray, A: int) -> Tuple[jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray, jnp.ndarray]:
        """
        Parameters:
