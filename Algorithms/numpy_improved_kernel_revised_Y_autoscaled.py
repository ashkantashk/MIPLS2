...
class PLS(BaseEstimator):
    ...
    def __init__(self, Signal_Type: str='NMR', algorithm: int = 1, dtype: np.float_ = np.float64) -> None:
    ...
    def predict(self, X: npt.ArrayLike, A: None or int = None) -> npt.NDArray[np.float_]:
        """
        Parameters:
        X: Predictor variables matrix (N x K)
